        ...
        else
        {
            ...
            if('details' == viewmode) {
                ...
                for(var ii = 0; ii < groupSize; ii++){
                    ...
                    //Yuki 08/06/2021 APPS-1082-P1-RENAME_DUPLICATED_ITERATION_VARIABLE
                    for(var jj = 1; jj <= graphNum; jj++) {  
                        var graphName = graphsInGroup[jj]; 
                    //END 08/06/2021 APPS-1082-P1-RENAME_DUPLICATED_ITERATION_VARIABLE
...
{     
    ...
    {   
        ...
        data += "<td>" + i + "</td>"; // Column for number
        data += "<td></td>"; // Column for short name
        data += "<td style='word-wrap:break-word;word-break:break-all;' width='25%;'></td>"; // Column for location
        data += "<td></td>"; // Column for size
